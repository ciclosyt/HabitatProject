...
-- # Fuente de informacion:: https://www.chirpstack.io/application-server/integrations/postgresql/ 


-- create the chirpstack_as_events user
create role chirpstack_as_events with login password 'admin4433';
